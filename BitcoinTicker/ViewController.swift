...
//  BitcoinTicker
//
//  Created by Satwik Singh on 23/06/2018.
...
class ViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        getBitCoinPriceData(url: baseURL+"AUD")
    ...
    func getBitCoinPriceData(url: String) {
        ...
        Alamofire.request(url, method: .get).responseJSON{
                ...
                if response.result.isSuccess {
                    ...
                    print("Sucess! Got the Bit Coin Price data")
    ...
    func updateBitCoinPriceData(json : JSON) {
        ...
        if let bitCoinPriceResult = json["ask"].double {
            bitcoinPriceLabel.text = symbolArray[symbol]+"\(bitCoinPriceResult)"
